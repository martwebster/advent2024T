...
import { extractOperations, sumLine, sumLineWithInstructions } from './day3';
...
describe('day 3', () => {
    ...
    test('sample 2', () => {
        expect(sumLineWithInstructions(["xmul(2,4)&mul[3,7]!^don't()_mul(5,5)+mul(32,64](mul(11,8)undo()?mul(8,5))"])).toBe(48)
     })

     test('part2', () => {
        const data = readTestData('./src/day3/input.txt');
        //31635268 is too low
        const result = sumLineWithInstructions(data)
